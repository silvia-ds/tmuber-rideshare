...
public class CityMap
{
  ...
  // Checks which city zone an address is in
  public static int getCityZone(String address){
    // checks for invalid address
    if (!validAddress(address))
      return -1;

    String[] parts = getParts(address); // uses other method to split address into parts
    // all "avenue" cases
    if (parts[2].equalsIgnoreCase("avenue")){
      // checks for zone 2 or 3
      if (parts[0].substring(0, 1).equals("1") || parts[0].substring(0, 1).equals("2") || parts[0].substring(0, 1).equals("3") || parts[0].substring(0, 1).equals("4") || parts[0].substring(0, 1).equals("5")){
        if (parts[1].substring(0, 1).equals("1") || parts[1].substring(0, 1).equals("2") || parts[1].substring(0, 1).equals("3") || parts[1].substring(0, 1).equals("4") || parts[1].substring(0, 1).equals("5"))
          return 3;
        else return 2;
      }
      // checks for zone 0 or 1 
      else if (parts[0].substring(0, 1).equals("6") || parts[0].substring(0, 1).equals("7") || parts[0].substring(0, 1).equals("8") || parts[0].substring(0, 1).equals("9")){
        if (parts[1].substring(0, 1).equals("1") || parts[1].substring(0, 1).equals("2") || parts[1].substring(0, 1).equals("3") || parts[1].substring(0, 1).equals("4") || parts[1].substring(0, 1).equals("5"))
          return 0;
        else return 1;
      }
    ...
    // all "street" cases
    else if (parts[2].equalsIgnoreCase("street")){
      // checks for zone 0 or 3
      if (parts[0].substring(0, 1).equals("1") || parts[0].substring(0, 1).equals("2") || parts[0].substring(0, 1).equals("3") || parts[0].substring(0, 1).equals("4") || parts[0].substring(0, 1).equals("5")){
        if (parts[1].substring(0, 1).equals("1") || parts[1].substring(0, 1).equals("2") || parts[1].substring(0, 1).equals("3") || parts[1].substring(0, 1).equals("4") || parts[1].substring(0, 1).equals("5"))
          return 3;
        else return 0;
      }
      // checks for zone 1 or 2 
      else if (parts[0].substring(0, 1).equals("6") || parts[0].substring(0, 1).equals("7") || parts[0].substring(0, 1).equals("8") || parts[0].substring(0, 1).equals("9")){
        if (parts[1].substring(0, 1).equals("1") || parts[1].substring(0, 1).equals("2") || parts[1].substring(0, 1).equals("3") || parts[1].substring(0, 1).equals("4") || parts[1].substring(0, 1).equals("5"))
          return 2;
        else return 1;
